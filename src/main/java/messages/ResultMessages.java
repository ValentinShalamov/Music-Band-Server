...
public class ResultMessages {
    ...
    public static final String LIST_OF_AVAILABLE_COMMAND = """
            ...
            - info: show the information about the music bands\s
            ...
            - add_if_min: add a music band if the number of sales of its best album is less than the existing albums\s
